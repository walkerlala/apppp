...
class Tooltip extends React.Component<TooltipProps, TooltipState> {
  ...
  wrapperRef: React.RefObject<HTMLElement> = React.createRef();
  ...
  get targetRef(): HTMLElement | null {
    ...
    if (this.wrapperRef.current.children.length === 0) {
      return null;
    }
    return this.wrapperRef.current.children.item(0) as HTMLElement;
  }
